...
一个用于课堂教学的大模型 API 学习工具。学生可以填写自己的 Base URL、模型名和 API Key，直观学习 API 连接、提示词、生成参数、多轮对话、Mermaid 思维导图和图像生成。
...
5. 点击“应用配置”，然后使用多轮对话、思维导图或图像生成功能。
